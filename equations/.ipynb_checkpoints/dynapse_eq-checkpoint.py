...
def dynapse_eq():
    return{'model': '''
                    ...
                    I_th_clip_syn_exc = Io*(I_syn_exc<=Io) + I_th_syn_exc*(I_syn_exc>Io) : amp
                    ...
                    I_th_syn_exc       : amp (constant)                 # Current flowing through ?? sets the DPI's threshold
                    ...
                    I_th_clip_syn_exc2 = Io*(I_syn_exc2<=Io) + I_th_syn_exc2*(I_syn_exc2>Io) : amp
                    ...
                    I_th_syn_exc2       : amp (constant)                 # Current flowing through ?? sets the DPI's threshold
                    ...
                    I_th_clip_syn_inh = Io*(I_syn_inh<=Io) + I_th_syn_inh*(I_syn_inh>Io) : amp
                    ...
                    I_th_syn_inh       : amp (constant)                 # Current flowing through ?? sets the DPI's threshold
                    ...
                    I_th_syn_shunt*(I_syn_shunt>Io) : amp  # DPI's gain factor
                    ...
                    I_th_syn_shunt        : amp (constant)    # Current flowing through ?? sets the DPI's threshold
...
def dynapse_namd_syn_eq(): # SLOW_EXC, NMDA
    ...
    return{'model': """
                    ...
                    """,
           'on_pre': """
                    I_syn_exc_post += I_wo_syn_exc_post*weight*I_th_syn_exc_post/(I_tau_syn_exc_post*((I_th_syn_exc_post/I_syn_exc_post)+1))
                    """,
           'on_post': """ """,
           'method': 'euler'}
...
def dynapse_ampa_syn_eq(): # FAST_EXC, AMPA
    ...
    return{'model': """
                    ...
                    """,
           'on_pre': """
                    I_syn_exc2_post += I_wo_syn_exc2_post*weight*I_th_syn_exc2_post/(I_tau_syn_exc2_post*((I_th_syn_exc2_post/I_syn_exc2_post)+1))
                    """,
           'on_post': """ """,
           'method': 'euler'}
...
def dynapse_gabab_syn_eq(): # SLOW_INH, GABA_B
    ...
    return{'model': """
                    ...
                    """,
           'on_pre': """
                     I_syn_inh_post += I_wo_syn_inh_post*-weight*I_th_syn_inh_post/(I_tau_syn_inh_post*((I_th_syn_inh_post/I_syn_inh_post)+1))
                     """,
           'on_post': """ """,
           'method': 'euler'}
...
def dynapse_gabaa_shunt_syn_eq(): # FAST_INH, GABA_A
    ...
    return{'model': """
                    ...
                    """,
           'on_pre': """
                     I_syn_shunt_post += I_wo_syn_shunt_post*-weight*I_th_syn_shunt_post/(I_tau_syn_shunt_post*((I_th_syn_shunt_post/I_syn_shunt_post)+1))
